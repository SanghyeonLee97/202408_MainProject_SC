...
<style type="text/css">
 ...
 <script>
    // 가상의 로그인 상태를 관리하기 위한 변수
    let isLoggedIn = false;

    // 로그인 버튼 클릭 시 동작
    function handleLoginButtonClick() {
        if (isLoggedIn) {
            // 로그인 상태인 경우, 마이페이지로 이동
    ...
    // 가상의 로그인 상태를 설정하는 함수 (로그인 후 호출할 수 있음)
    ...
    <div class="row mb-5 " >
	    <div class="col-12 content-head">
		    <div style="display: flex; align-items: center; justify-content: center; flex: 1;">
		        <a href="Main.jsp" style="text-decoration: none; color: black"><img src="../img/KakaoTalk_20240830_173505125.png" id="main_img" width="100px" height="100px" style="margin-right: 20px;"></a>
		        <p id='main'><a href="Main.jsp" style="text-decoration: none; color: black">카페 IN 홍대</a></p>
		    </div>
		    <div id="welcome message" class="hidden"></div>
			<c:if test="${sessionScope.user ==null }">
				<button  id="button1" type="button" onclick="move()">로그인</button>
			</c:if>
			<c:if test="${sessionScope.user != null }">
		...
		<div class="container-fluid" style=" padding: 10px; margin-top: 50px">
			<ul id="list">
				...
				<li><a href="Age_Re.jsp">연령별 추천</a></li>
				<li><a href="My_Re.jsp">선호카페 추천</a></li>
			</ul>
		</div>
		<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" >
			<div class="input-group" style="margin-left: 500px; margin-top: 70px;">
