...
public class IndexController {
    ...
    public String connectIndex(Model model) {
        model.addAttribute("LRArrCDTO", categoryRecommendation.categoryRecommendation("cafe_likes_top20.py","",""));
        model.addAttribute("RRArrCDTO", categoryRecommendation.categoryRecommendation("cafe_reviews_top20.py","",""));
        return "Main";
    }
